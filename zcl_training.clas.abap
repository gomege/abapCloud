CLASS zcl_training_007 DEFINITION
public
final
create public .
public section.
...
private section.
ENDCLASS.
CLASS zcl_training_007 IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.
DATA it_training TYPE standard table of ZTRAINING007_TBL.
it_training = value #(
...
'20160518'
ISCOMPLETE = '' CAPACITY = '10' ) ).
DELETE FROM ZTRAINING007_TBL.
INSERT ZTRAINING007_TBL FROM TABLE @it_training.
